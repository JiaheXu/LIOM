...
namespace superodom {
    ...
    void laserMapping::initInterface() {
       ...
       // {
            slam.debug_view = std::make_shared<superodom::DebugView>();
       // }
    ...
    void laserMapping::laserFeatureInfoHandler(const super_odometry_msgs::msg::LaserFeature::SharedPtr msgIn) {
        // RCLCPP_INFO(this->get_logger(), "laserFeaturueInfoCB from /feature_info");
        mBuf.lock();
    ...
    void laserMapping::IMUOdometryHandler(const nav_msgs::msg::Odometry::SharedPtr imuOdometry) {
        // RCLCPP_INFO(this->get_logger(), "imuOdomCB from /integrated_to_init");
        mBuf.lock();
