...
//         if (!readParameters()) {
//             RCLCPP_ERROR(this->get_logger(), "[SuperOdometry::ousterTransform] Could not read parameters. Exiting...");
//             rclcpp::shutdown();
//         }
...
//     auto node =  std::make_shared<superodom::ousterTransform>();
//     // ros::NodeHandle node;
//     // ros::NodeHandle privateNode("~");
//     RCLCPP_INFO(node->get_logger(), "\033[1;32m----> LaserMapping Started.\033[0m");

//     // superodom::ousterTransform OT;

//     // OT.setUpROS(&node, &privateNode);

//     // std::thread mapping_process{&superodom::laserMapping::process, &node};
