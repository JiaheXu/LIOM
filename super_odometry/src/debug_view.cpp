...
#include <super_odometry/debug_view.h>

superodom::DebugView::DebugView() : Node("debug_view_node")
{
...
void superodom::DebugView::addOptimizationIterationPose(const Transformd &pose_tf, const double timestamp)
{
...
/**
         ...
         * @param timestamp 
         */
void superodom::DebugView::publishFeaturesFromMap(const pcl::PointCloud<PointType> &corner,
...
/**
         ...
         * @param timestamp 
         */
void superodom::DebugView::publishFeaturesFromScan(const pcl::PointCloud<PointType> &corner,
                                                   const pcl::PointCloud<PointType> &surface, const double timestamp)
{
    size_t size_corner = corner.points.size();
    size_t size_surface = surface.points.size();
...
void superodom::DebugView::addObservability(const PointType & fromScan, int feature_type)
{
...
void superodom::DebugView::addCorrespondences(const std::vector<PointType>  &fromMap, const PointType &fromScan, bool corner, Eigen::Vector3d& norm)
{
...
void superodom::DebugView::clearCorrespondences(){
    corner_markers.restart();
    surface_markers.restart();
}

void superodom::DebugView::publishCorrespondences(double timestamp)
{
...
void superodom::DebugView::publishObservibility(double timestamp)
{
...
void superodom::DebugView::publishUncertainty(double uncer_x, double uncer_y, double uncer_z,
